-- ============================================================================
-- FINAL SOFT DELETE RPC FUNCTION FIX
-- ============================================================================
-- This fixes the soft_delete_collection RPC function to work with the ACTUAL
-- unified_collections table structure based on the real data
...
-- Verify the fix
SELECT 'Final soft delete RPC functions fixed successfully' as status;
