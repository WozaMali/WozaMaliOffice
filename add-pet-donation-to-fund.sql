-- Add Legacy Music's PET donation to Green Scholar Fund
-- We know: 6kg Plastic Bottles = R9.00
...
-- Step 3: Show the updated fund balance
...
-- Step 4: Show the new transaction
