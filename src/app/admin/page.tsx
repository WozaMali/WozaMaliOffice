        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">{mockStats.activeCollectors} online</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">+{mockStats.monthlyGrowth}% monthly</p>
            </div>
          </div>
        </CardContent>
      </Card>
