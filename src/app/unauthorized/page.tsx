          ...
          <CardContent className="space-y-6">
            <div className="text-center space-y-3">
              <p className="text-gray-600 dark:text-gray-300">
                You don&apos;t have permission to access this administrative area. This portal is restricted to authorized Woza Mali staff and administrators only.
              </p>
              ...
              <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-4">
                ...
                <ul className="text-sm text-orange-700 dark:text-orange-300 space-y-1 text-left">
                  <li>• Contact your supervisor for admin access</li>
                  <li>• Use the collector portal if you&apos;re a collector</li>
